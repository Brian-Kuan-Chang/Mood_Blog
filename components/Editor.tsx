    ...
    <div className="w-full h-full grid grid-cols-3 gap-0 relative">
      ...
      <div className="border-l border-black/5">
        <div
          ...
          className="h-[100px] bg-blue-200 text-white p-8"
        >
        ...
        <div>
          <ul role="list" className="divide-y divide-gray-200">
            <li className="py-4 px-8 flex items-center justify-between">
              ...
              <div className="text-base m-2 text-right w-2/3 ">
                {currentEntry.analysis.subject}
              </div>
            </li>

            <li className="py-4 px-8 flex items-center justify-between">
              <div className="text-xl font-semibold w-1/3">Mood</div>
              <div className="text-base m-2 text-right w-2/3">
            ...
            <li className="py-4 px-8 flex items-center justify-between">
              <div className="text-xl font-semibold w-1/3">Negative</div>
              <div className="text-base m-2 w-2/3 text-right">
